...
public struct YPImagePickerConfiguration {
    ...
    /// Defines if the navigation bar cancel button should should has custom image
...
public struct YPConfigVideo {
    ...
    /// Get video without time limits and croppings
    public var skipTimeLimitsAndCropping: Bool = false
}
